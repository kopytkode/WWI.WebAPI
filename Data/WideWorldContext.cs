...
using WWI.WebAPI.Models;

namespace WWI.WebAPI.Data;

public partial class WideWorldContext : DbContext
{
    public WideWorldContext()
    {
    }

    public WideWorldContext(DbContextOptions<WideWorldContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:WWIConString");
